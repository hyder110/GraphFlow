...
- [ ]  **Task 13.2:** Include tests for the `build_langgraph_from_definition` function to ensure each node/edge is created properly.
- [ ]  **Task 13.3:** Write integration tests that start up a test DB, insert a sample graph, and run it to verify correct behavior.
- [ ]  **Task 13.4:** Create a Next.js end-to-end test or Cypress test to open the app, create a graph, save it, reload it, and run it.
- [ ]  **Task 13.5:** Ensure coverage for error cases (bad graph definitions, missing user input, invalid agent types).
- [ ]  **Task 13.6:** Create a QA checklist for manual testing in the README or docs.
